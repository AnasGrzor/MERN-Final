...
const Contact = () => {
  return (
    <>
      {/* This form uses  https://VeilMail.io to protect your email address behind a captcha so your email address cannot be scraped and spammed */}
      <section className="text-gray-600 body-font bg-purple-100">
        <div
          className="container h-[calc(100vh-168px] flex flex-col md:flex-row lg:max-w-5xl w-full px-5 py-12 md:py-24 mx-auto section"
          id="contact-form"
        >
          ...
          <div className="md:w-2/3 w-full mt-10 md:mt-0 md:pl-28">
            ...
            >
              ...
              <div className="p-2 w-full">
                <button
                  type="submit"
                  className="flex text-white bg-purple-700 border-0 py-4 px-6 focus:outline-none hover:bg-purple-900 rounded text-xl font-bold shadow-lg mx-0 flex-col text-center g-recaptcha"
                >
                  Send Message ✉
                </button>
              </div>
